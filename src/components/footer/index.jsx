...
// Các nhóm link footer – truyền link khác theo từng trang nếu cần
        ...
        <div className="app-footer-top">
          <div>
            ...
            <p className="app-footer-description">
              The premium destination for cyclists to buy and sell
              high-performance equipment with confidence and ease.
            </p>
