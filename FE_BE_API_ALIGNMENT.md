...
| **Inspector**    | `GET /inspection/pending`, `POST /inspection/{postId}/submit`                                                                                                                                          | Body submit: 6 điểm `colorScore`…`wheelScore` (mỗi giá trị 0\|3\|7\|10), `notes?`. BE tính `conditionPercent`, `overallCondition`, PASS/FAIL (`InspectionService`).                                                                       |
